...
const messages = defineMessages({
    ...
    enrolled: {
        defaultMessage: 'You are enrolled in this project run',
    ...
    enrollmentClosed: {
        defaultMessage: 'Enrollment in this project run is closed at the moment',
        ...
        case step === Step.ENROLLMENT_FAILED:
            return (
                <React.Fragment>
                    <button
                        onClick={enroll}
                        className={`course-run-enrollment__cta ${step === Step.ENROLLING ? 'course-run-enrollment__cta--loading' : ''
                            }`}
