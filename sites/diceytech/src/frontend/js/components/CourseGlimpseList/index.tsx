...
const messages = defineMessages({
  courseCount: {
    defaultMessage:
      'Showing {start, number} to {end, number} of {courseCount, number} {courseCount, plural, one {project} other {projects}} matching your search',
    description:
  ...
  offscreenCourseCount: {
    defaultMessage:
      '{courseCount, number} {courseCount, plural, one {project} other {projects}} matching your search',
