"""
Django settings for the richie diceytech project.
"""
import json
import os
...
class Base(StyleguideMixin, DRFMixin, RichieCoursesConfigurationMixin, Configuration):
    ...
    * DB_PORT
    ...
    WSGI_APPLICATION = "diceytech.wsgi.application"
        ...
        "PROFILE_URLS": values.DictValue(
            {
                ...
                "jobs": {
                    "label": _("Jobs"),
                    "href": _("https://portfolio.diceytech.co.uk/jobs"),
                },
                "profile": {
                    "label": _("Profile"),
...
class Production(Base):
    ...
    AWS_MEDIA_BUCKET_NAME = values.Value(
        "production-diceytech-diceytech-richie-media"
    )
...
class Feature(Production):
    ...
    AWS_MEDIA_BUCKET_NAME = values.Value(
        "feature-diceytech-diceytech-richie-media"
    )
...
class Staging(Production):
    ...
    AWS_MEDIA_BUCKET_NAME = values.Value(
        "staging-diceytech-diceytech-richie-media"
    )
...
class PreProduction(Production):
    ...
    AWS_MEDIA_BUCKET_NAME = values.Value(
        "preprod-diceytech-diceytech-richie-media"
    )
